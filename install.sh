...
sudo docker-compose exec Account bash -c "chmod -R 777 bootstrap && chmod -R 777 storage && composer install && php artisan key:generate"
sudo docker-compose exec Main bash -c "chmod -R 777 bootstrap && chmod -R 777 storage && composer install && php artisan key:generate"
sudo docker-compose exec Product bash -c "chmod -R 777 bootstrap && chmod -R 777 storage && composer install && php artisan key:generate"
